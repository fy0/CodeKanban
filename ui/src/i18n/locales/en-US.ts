export default {
  ...
  task: {
    ...
    startWorkTooltip: 'Focus the linked terminal or create a new terminal for this task',
  ...
  terminal: {
    ...
    unlinkTaskConfirm: 'Unlink "{title}" from its task?',
    taskUnlinked: 'Terminal unlinked from task',
    taskUnlinkFailed: 'Failed to unlink terminal from task',
    ...
    linkTask: 'Link Task',
    linkTaskTitle: 'Select a task to link',
    noAvailableTasks: 'No available tasks (to do or in progress)',
    taskLinked: 'Task linked successfully',
    taskLinkFailed: 'Failed to link task',
    taskAlreadyLinked: 'Linked to another terminal',
