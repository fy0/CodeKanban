export default {
  ...
  terminal: {
    ...
    processInfoCopied: 'Process info copied to clipboard',
  ...
  settings: {
    ...
    aiAssistantStatusTracking: 'AI Assistant Status Tracking',
    ...
    aiStatusHasIssues: '(Has issues)',
    aiStatusUntested: '(Untested)',
    aiStatusIssueTooltip: 'Codex uses cursor manipulation which may cause false detection',
