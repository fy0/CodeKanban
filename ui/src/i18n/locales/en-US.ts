export default {
  ...
  terminal: {
    ...
    aiAssistantDetected: 'AI Assistant',
    statusLabel: 'Status',
  ...
  settings: {
    ...
    aiAssistantStatusTracking: 'AI Assistant Status Tracking (Beta)',
    aiAssistantStatusTrackingTip: 'Control whether to track AI assistant working status (thinking, executing, waiting for input, etc.)',
    aiAssistantClaudeCode: 'Claude Code',
    aiAssistantCodex: 'OpenAI Codex',
    aiAssistantTrackingMode: 'Tracking Mode',
    aiAssistantTrackingModeTip: 'Capture forces a redraw via /capture for every detection (recommended). Virtual Terminal replays chunks locally and matches legacy behavior.',
    aiAssistantTrackingModeCapture: 'Capture (default)',
    aiAssistantTrackingModeVirtual: 'Virtual Terminal',
    ...
    aiStatusQwenSupport: 'Supports: Waiting, Working',
