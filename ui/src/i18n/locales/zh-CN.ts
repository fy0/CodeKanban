export default {
  ...
  task: {
    ...
    archiveDialogTitle: '归档已完成任务',
    archiveDialogHint: '汇总当前「已完成」列的任务，一键复制后再勾选需要归档的条目。',
    archiveCopy: '一键复制',
    archiveCopied: '任务汇总已复制',
    archiveCopyFailed: '复制任务汇总失败',
    archiveSelectAll: '全选',
    archiveSelectRequired: '请先勾选要归档的任务',
    archiveAction: '归档选中项',
    archiveSuccess: '已归档 {count} 个任务',
    archivePartialFailed: '有 {count} 个任务归档失败，请重试',
    archiveEmptyHint: '当前没有可归档的已完成任务',
    ...
    aiSessions: 'AI 对话记录',
    noAiMessages: '暂无对话记录',
    linkedAiSessions: '关联的 AI 会话',
    linkAiSession: '关联会话',
    unlinkAiSession: '解除关联',
    selectAiSession: '选择 AI 会话',
    noAvailableAiSessions: '暂无可关联的 AI 会话',
    aiSessionLinked: '会话已关联',
    aiSessionUnlinked: '已解除会话关联',
    aiSessionLinkFailed: '关联会话失败',
    aiSessionUnlinkFailed: '解除关联失败',
    copySessionId: '复制 Session ID',
    sessionIdCopied: 'Session ID 已复制',
    viewConversation: '查看对话',
    loadAiSessionsFailed: '加载 AI 会话失败',
    confirmUnlinkAiSession: '确定要解除与此 AI 会话的关联吗？',
    saveChanges: '保存修改',
    ...
    // Task Card
    startWork: '开始工作',
    startWorkTooltip: '开始工作：选择终端或 AI 工具',
    startWorkMenuTerminal: '终端',
    startWorkMenuClaude: 'CC（Claude Code）',
    startWorkMenuCodex: 'Codex',
    startWorkPromptTitle: '开始工作 - {agent}',
    startWorkPromptPlaceholder: '输入要执行的 Prompt（默认使用任务标题，可自行修改）',
    startWorkPromptRequired: '请输入 Prompt',
    startWorkPromptRun: '执行',
    agentStarted: '已启动 {agent} 并发送 Prompt',
    copyTaskName: '复制任务名',
    quickEdit: '快捷编辑',
    quickDelete: '快捷删除',
    duePrefix: '截止',
    jumpToLinkedTerminal: '已切换到关联的终端',
    openedLinkedTaskPanel: '已打开关联任务详情',
    noLinkedTerminal: '当前任务暂无关联终端，请点击「开始工作」创建',
    taskNotFound: '未找到任务，请刷新看板后重试',
    status: {
      todo: '待办',
      inProgress: '进行中',
      review: '审查中',
  ...
  webSession: {
    ...
    importCodexSessionScanning: '正在扫描当前项目下的 Codex 历史会话...',
    importCodexSessionEmpty: '当前项目下暂无可导入的 Codex 历史会话',
    importCodexSessionHideImported: '隐藏已导入会话',
    importCodexSessionSummary: '待导入 {ready} 个，已导入 {duplicated} 个',
    importCodexSessionAction: '导入',
    importCodexSessionSuccess: 'Codex 会话已导入',
    ...
    planScheduleKindTitle: '启动条件',
    planScheduleKindAtTime: '指定时间',
    planScheduleKindWhenIdle: '空闲时开始',
    scheduleSendPresetTitle: '常用时间',
    scheduleSendCustomTime: '自定义时间',
    scheduleSendSelectedTime: '将于 {time} 发送',
    scheduleSendModeTitle: '到点后发送方式',
  ...
  settings: {
    ...
    terminalTabCompletionBg: '完成提醒背景',
    terminalTabCompletionBorder: '完成提醒边框',
    terminalTabApprovalBg: '审批提醒背景',
    terminalTabApprovalBorder: '审批提醒边框',
    fontSize: '字体大小',
    fontFamily: '字体',
    resetTheme: '恢复默认主题',
    themeSettings: '界面设置',
    ...
    terminalTheme: '终端配色',
    terminalThemeTip: '选择终端配色方案，更改后需刷新终端标签页生效',
    ...
    aiAssistantStatusTracking: 'AI 编码助手状态监测 (测试中)',
    aiAssistantStatusTrackingTip: '控制是否监测 AI 编码助手的工作状态（思考、执行、等待输入等）',
    ...
    aiStatusEnabled: '已启用',
    aiStatusDisabled: '已禁用',
    aiStatusAccurate: '(状态监测准确)',
    aiStatusUntested: '(未充分测试)',
    aiStatusClaudeSupport: '支持: 等待输入、工作中、审批中(部分)',
    aiStatusCodexSupport: '支持: 等待输入、工作中、审批中',
    aiStatusQwenSupport: '暂不支持（因重构）',
    aiStatusSaveSuccess: 'AI 编码助手状态监测配置已保存',
