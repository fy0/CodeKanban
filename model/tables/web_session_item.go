...
type WebSessionItemTable struct {
	...
	WebSessionID   string  `gorm:"type:text;not null;index:idx_web_session_item_order,priority:1;index:idx_web_session_item_source,priority:1;index:idx_web_session_item_run,priority:1;index" json:"webSessionId"`
